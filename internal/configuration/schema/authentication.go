...
type AuthenticationBackendLDAPAttributes struct {
	...
	MailAlias         string `koanf:"mail_alias" yaml:"mail_alias,omitempty" toml:"mail_alias,omitempty" json:"mail_alias,omitempty" jsonschema:"title=Attribute: User Mail Alias" jsonschema_description:"The directory server attribute which contains a personal/alias mail address used as fallback when the primary mail is an SSO-only address."`
